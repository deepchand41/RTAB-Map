...
class Metaclass_MapData(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from rtabmap_msgs.msg import NodeData
...
class MapData(metaclass=Metaclass_MapData):
    ...
    _fields_and_field_types = {
        ...
        'nodes': 'sequence<rtabmap_msgs/NodeData>',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['std_msgs', 'msg'], 'Header'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['rtabmap_msgs', 'msg'], 'MapGraph'),  # noqa: E501
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['rtabmap_msgs', 'msg'], 'NodeData')),  # noqa: E501
    )
