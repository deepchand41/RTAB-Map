...
public:
    ...
    void retranslateUi(QDialog *ExportCloudsDialog)
    {
        ...
        label_147->setText(QApplication::translate("ExportCloudsDialog", "Depth's edge bleeding filter error (0 means disabled). Reduce depth noise around edges.", nullptr));
        doubleSpinBox_depthEdgeFiltering->setSuffix(QApplication::translate("ExportCloudsDialog", " m", nullptr));
        label_149->setText(QApplication::translate("ExportCloudsDialog", "Minimum depth confidence: 0% is low confidence, 100% is high confidence. Ignored if no depth confidence images were recorded or if set to 0%.", nullptr));
        spinBox_depthConfidence->setSuffix(QApplication::translate("ExportCloudsDialog", " %", nullptr));
...
"By Node ID and Camera Index: NodeID*10+CameraIndex", nullptr));
        ...
        doubleSpinBox_camProjMaxDepthError->setSuffix(QApplication::translate("ExportCloudsDialog", " m", nullptr));
        label_meshingTextureSize_20->setText(QApplication::translate("ExportCloudsDialog", "For all points registered to same pixel, only those close enough to the closest point will be colored with same color (0 means only the closest point of all points registered in same pixel is colored).", nullptr));
        ...
        label_texturingVertexColorPolicy->setText(QApplication::translate("ExportCloudsDialog", "Output vertex color policy.", nullptr));
        comboBox_texturingColorPolicy->setItemText(0, QApplication::translate("ExportCloudsDialog", "Colorless (standard OBJ)", nullptr));
        comboBox_texturingColorPolicy->setItemText(1, QApplication::translate("ExportCloudsDialog", "Keep color on textureless polygons only", nullptr));
        comboBox_texturingColorPolicy->setItemText(2, QApplication::translate("ExportCloudsDialog", "Keep all color", nullptr));
