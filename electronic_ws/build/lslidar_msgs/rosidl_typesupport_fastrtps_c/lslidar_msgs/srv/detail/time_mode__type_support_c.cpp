...
static size_t _TimeMode_Request__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_lslidar_msgs__srv__TimeMode_Request(
    full_bounded, 0);
}
...
static size_t _TimeMode_Response__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_lslidar_msgs__srv__TimeMode_Response(
    full_bounded, 0);
}
