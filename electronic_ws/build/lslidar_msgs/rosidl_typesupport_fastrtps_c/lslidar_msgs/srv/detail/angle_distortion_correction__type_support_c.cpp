...
static size_t _AngleDistortionCorrection_Request__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_lslidar_msgs__srv__AngleDistortionCorrection_Request(
    full_bounded, 0);
}
...
static size_t _AngleDistortionCorrection_Response__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_lslidar_msgs__srv__AngleDistortionCorrection_Response(
    full_bounded, 0);
}
