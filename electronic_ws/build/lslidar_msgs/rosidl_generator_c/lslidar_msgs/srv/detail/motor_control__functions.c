  ...
  lslidar_msgs__srv__MotorControl_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    lslidar_msgs__srv__MotorControl_Request * data =
      (lslidar_msgs__srv__MotorControl_Request *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!lslidar_msgs__srv__MotorControl_Request__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          lslidar_msgs__srv__MotorControl_Request__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  lslidar_msgs__srv__MotorControl_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    lslidar_msgs__srv__MotorControl_Response * data =
      (lslidar_msgs__srv__MotorControl_Response *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!lslidar_msgs__srv__MotorControl_Response__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          lslidar_msgs__srv__MotorControl_Response__fini(&data[i]);
        }
        free(data);
        return false;
      }
