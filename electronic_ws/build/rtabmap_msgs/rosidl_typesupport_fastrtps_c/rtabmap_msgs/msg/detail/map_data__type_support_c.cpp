...
#include "rtabmap_msgs/msg/detail/node_data__functions.h"  // nodes
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: nodes
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, rtabmap_msgs, msg, NodeData
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: nodes
  {
    ...
    if (ros_message->nodes.data) {
      rtabmap_msgs__msg__NodeData__Sequence__fini(&ros_message->nodes);
    }
  ...
  size_t current_alignment)
{
  ...
  // field.name nodes
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_rtabmap_msgs__msg__NodeData(
  ...
  size_t current_alignment)
{
  ...
  // member: nodes
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_rtabmap_msgs__msg__NodeData(
        full_bounded, current_alignment);
    }
  }
